...
2. EVERY COPY: If this project has more than one checkout or deployment, propagate the
   change through its documented release path - never by hand-copying between them.
